...
<section class="section" id="tools">
    ...
    <p>Access the ML workspace provisioned for the May 2025 Open House.</p>
    <ul>
...
<section class="section" id="report-issues">
    <h2>Report Issues</h2>
    <p>If you encounter any issues while using the OpenHouse Portal, please report them on our GitHub repository:</p>
...
<footer>
    <p>© 2025 OPEN HOUSE CHoRUS Portal. All rights reserved.</p>
