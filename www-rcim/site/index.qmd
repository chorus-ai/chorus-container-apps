...
<section class="section" id="tools">
    ...
    <p>Access the ML workspace provisioned for the RCMI Project.</p>
    <ul>
...
<section class="section" id="report-issues">
    <h2>Report Issues</h2>
    <p>If you encounter any issues while using the RCMI Portal, please report them on our GitHub repository:</p>
