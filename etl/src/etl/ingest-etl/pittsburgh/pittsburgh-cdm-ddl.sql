CREATE TABLE src_condition_occurrence
(
...
CREATE TABLE src_device_exposure
(
...
CREATE TABLE src_drug_exposure
(
...
CREATE TABLE src_observation_period
(
...
CREATE TABLE src_procedure_occurrence
(
...
CREATE TABLE src_visit_occurrence
(
    visit_occurrence_id           TEXT,
    person_id                     TEXT,
