...
CREATE TABLE visit_occurrence (
  ...
  src_person_id integer,
  src_visit_occurrence_id integer,
  src_prec_visit_occurrence_id integer,
  src_name varchar(50)
);
...
CREATE TABLE visit_detail (
  ...
  src_person_id integer,
  src_visit_occurrence_id integer,
  src_visit_detail_id integer,
  src_prec_visit_detail_id integer,
  src_parent_visit_detail_id integer,
  src_name varchar(50)
);
