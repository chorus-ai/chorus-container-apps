...
CREATE TABLE omopcdm.src_drug_era
(
    drug_era_id         TEXT,
    person_id           TEXT,
    drug_concept_id     TEXT,
    drug_era_start_date TEXT,
    drug_era_end_date   TEXT,
    drug_exposure_count TEXT,
    gap_days            TEXT
);

CREATE TABLE omopcdm.src_condition_era
(
    condition_era_id           TEXT,
    person_id                  TEXT,
    condition_concept_id       TEXT,
    condition_era_start_date   TEXT,
