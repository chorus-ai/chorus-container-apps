...
<div class="warmup-container">
  <button id="warmup-lab" class="warmup-btn">Start App</button>
  <span id="status-lab" class="warmup-status"></span>
</div>
<a href="/lab/" id="link-lab" class="cta disabled">Get Started</a>
:::
