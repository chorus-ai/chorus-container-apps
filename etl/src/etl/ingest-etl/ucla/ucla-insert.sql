...
SELECT
    ...
    vd.admitting_source_concept_id::float::bigint,
    vd.admitting_source_value,
    vd.discharge_to_concept_id::float::bigint,
...
SELECT
    ...
    vo.admitting_source_concept_id::float::bigint,
    admitting_source_value,
    vo.discharge_to_concept_id::float::bigint,
...
SELECT
    'UCLA' AS cdm_source_name,
    'UCLA' AS cdm_source_abbreviation,
    'UCLA' AS cdm_holder,
    ...
    (SELECT vocabulary_version FROM omopcdm.vocabulary WHERE vocabulary_id = 'None') AS vocabulary_version;
