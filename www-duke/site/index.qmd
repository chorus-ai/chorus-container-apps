...
<style>
    ...
    header {
        ...
        padding: 20px;
        text-align: center;
        border-bottom: 4px solid #EEBD60;
    }
...
<section class="section" id="tools">
    ...
    <p>Access the ML workspace provisioned for the DukeDatathon.</p>
    <ul>
    ...
    <p>ℹ️ You will need to re-authenticate with your institutional credentials in this space.</p>
...
<section class="section" id="report-issues">
    <h2>Report Issues</h2>
    <p>If you encounter any issues while using the DukeDatathon Portal, please report them on our GitHub repository:</p>
...
<footer>
    <p>© 2025 RCMI CHoRUS Portal. All rights reserved.</p>
